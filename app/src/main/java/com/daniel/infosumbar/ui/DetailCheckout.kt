                        ...
                        try {
                            val url =
                                "https://api.whatsapp.com/send?phone=" + "+62812-7575-7509" + "&text=" + URLEncoder.encode(
                                    "Hai infosumbar, saya *${value!!["nama"]}*, email/no hp  *${value["email"]}*/*${value["no_hp"]}*, kode transaksi *${value["no_transaksi"]}* jumlah tagihan *Rp ${value["tagihan"]}* sudah menyelesaikan proses " +
                                            "pemesanan iklan. Untuk informasi lebih lanjut bisa hubungi saya di email/no hp yang tertera di atas. Terima kasih.",
                                    "UTF-8"
                                )
